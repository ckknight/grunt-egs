try {
  if (typeof top === "object" && top !== null && typeof top.opener === "object" && top.opener !== null && !top.opener.myCoverage) {
    top.opener.myCoverage = {};
  }
} catch (e) {}
try {
  if (typeof top === "object" && top !== null) {
    try {
      if (typeof top.opener === "object" && top.opener !== null && top.opener.myCoverage) {
        top.myCoverage = top.opener.myCoverage;
      }
    } catch (e) {}
    if (!top.myCoverage) {
      top.myCoverage = {};
...
if (typeof myCoverage !== "object") {
  myCoverage = {};
}
if (!myCoverage["test/fixtures/hello.egs"]) {
  (function () {
    var cov, i, lines;
    myCoverage["test/fixtures/hello.egs"] = cov = [];
...
if (!myCoverage["test/fixtures/use-hello.egs"]) {
  (function () {
    var cov, i, lines;
    myCoverage["test/fixtures/use-hello.egs"] = cov = [];
    for (i = 0, lines = [1]; i < 1; ++i) {
      cov[lines[i]] = 0;
    }
      ...
      return function (write, context, helpers) {
        ...
        function _step(_received) {
          while (true) {
            switch (_state) {
            case 0:
              ++myCoverage["test/fixtures/use-hello.egs"][1];
              ++_state;
              return {
                done: false,
